  ...
  <div class="container">
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        ...
        <form action="/blog/member/inputPro" method="post" class="validation-form" novalidate>
           <div class="row">
          ...
          <div class="mb-4"></div>
          <button class="btn btn-primary btn-lg btn-block w-100" type="submit">가입 완료</button>
        </form>
      </div>
    </div>
